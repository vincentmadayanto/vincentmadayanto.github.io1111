<template>
    <v-data-table :headers="headers" :items="drinks" :search="search" sort-by="calories" class="elevation-1">
        <template v-slot:top>
                        ...
                        <v-card-text>
                            <v-container>
                                <v-row>
                                    ...
                                    <v-select
                                        :items="items"
                                        :menu-props="{ top: true, offsetY: true }" v-model="editedItem.calories" label="Calories"
                                    ></v-select>
                                    </v-col>
                                    <v-col cols="12" sm="6" md="4">
